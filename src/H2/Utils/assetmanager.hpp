#pragma once
#include "../ZoneUtils/Zone/ZoneMemory.hpp"
...
namespace zonetool
{
	namespace assetmanager
	{
		...
		{
		public:
			native_reader(char* data, ZoneTool::ZoneMemory* mem)
				: data_(data)
				  , memory(mem)
			{
			}
		...
		public:
			reader(const std::string& name, ZoneTool::ZoneMemory* mem)
			{
				memory = mem;
				initialize(name);
			}

			reader(ZoneTool::ZoneMemory* mem)
			{
				memory = mem;
			}
